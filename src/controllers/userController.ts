  ...
  try {
    ...
    res.status(201).json({
      ...
      user: {
        ...
        memberSince: user.created_at ? new Date(user.created_at).toLocaleDateString() : 'N/A', // Use created_at for memberSince
...
export const getUserProfile = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const userProfileForFrontend = {
      ...
      memberSince: userProfile.created_at ? new Date(userProfile.created_at).toLocaleDateString() : 'N/A', // Use created_at for memberSince
...
export const updateUserProfile = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const updatedUserForFrontend = {
      ...
      memberSince: updatedUser.created_at ? new Date(updatedUser.created_at).toLocaleDateString() : 'N/A', // Use created_at for memberSince
